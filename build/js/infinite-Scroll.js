...
//     }
// }
var count = 10; //보여줄 노출 갯수

window.addEventListener("scroll", function (e) {
  var footer = document.querySelector('#footer').offsetHeight - 16;
  var isScrollEnd = window.innerHeight + window.scrollY + footer > document.body.offsetHeight;
  var fullContent = document.querySelector('#scrollList .list');
...
var scroll_position = localStorage.getItem("more-scroll");
